...
// way id
Street.prototype.getWid = function(){ return this.wid; };
Street.prototype.setWid = function( wid ){
  if( !wid ){ throw new Error( 'invalid wid' ); }
  this.wid = wid;
  return this;
};

// max speed
Street.prototype.getMaxspeed = function(){ return this.maxspeed; };
Street.prototype.setMaxspeed = function( maxspeed ){
  this.maxspeed = maxspeed;
  return this;
};

// type
Street.prototype.getType = function(){ return this.type; };
Street.prototype.setType = function( type ){
