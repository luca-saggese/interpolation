...
// maxSpeed
Address.prototype.getMaxSpeed = function(){ return this.max_speed; };
Address.prototype.setMaxSpeed = function( max_speed ){
  if( 'number' !== typeof max_speed  ){
    throw new Error( 'invalid max_speed' );
  }
...
// maxSpeed
Address.prototype.getHighwayType = function(){ return this.highway_type; };
Address.prototype.setHighwayType = function( highway_type ){
  if( 'string' !== typeof highway_type  ){
    throw new Error( 'invalid max_speed' );
  }
  this.highway_type = highway_type.toLowerCase();
  return this;
};
